...
- **안전한 정보 관리**: 모든 정보는 메모리에만 저장되며 종료 시 자동 삭제
...
> ⚠️ **보안 안내**: 모든 결제 정보는 메모리에만 저장되며, 프로그램 종료 시 자동으로 삭제됩니다.
...
- **로컬 저장 없음**: 로그인 정보와 카드 정보는 파일로 저장되지 않습니다
- **메모리 관리**: 프로그램 종료 시 모든 민감 정보가 메모리에서 완전히 제거됩니다
